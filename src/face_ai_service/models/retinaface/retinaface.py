...
from face_ai_service.models.retinaface.layers import FPN, SSH
from face_ai_service.models.retinaface.mobilenet025 import MobileNetV1
...
class RetinaFace(nn.Module):
    def __init__(self, cfg=None, phase="train", pre_train=False):
